export function EPComponent(){

    return <>
    
   <h2 className="ml-44 mb-2">Alle evenementen</h2>
   <div className="flex flex-wrap justify-center content-around" id="flex1">
              ...
              <div className="mx-2 my-6">
                ...
                <h3 className="text-left">Step Up 5</h3>
                <div className="text-left"><a className="meerInfoLink" href="/">Meer weten over Celebration of some sort</a></div>
              </div>
              ...
              <div className="mx-2 my-6">
                <img className="Event_img rounded-2xl" src="https://cdn.pixabay.com/photo/2014/08/29/05/00/dance-430554_1280.jpg" alt="" />
                <h3 className="text-left">Step Up Another sequel</h3>
                <div className="text-left"><a className="meerInfoLink" href="/">Meer weten over Celebration of some sort</a></div>
              </div>
    </div> </>
