...
export function EvenementenHP() {
    ...
    <div className="flex justify-center content-around" id="flex1">
              <div className="mx-2 rounded-md">
                <a href="/Evenementen" id="Chinese_New _ears"><img className=" Event_img rounded-2xl" src="https://cdn.pixabay.com/photo/2016/11/08/05/15/ramayana-festival-1807516_1280.jpg" alt="Link en een foto van een asian celebration evenement"/></a>
              </div>
